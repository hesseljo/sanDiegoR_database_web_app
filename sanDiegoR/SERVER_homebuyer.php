    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div class="row">
          ...
          if(!($stmt = $mysqli->prepare("INSERT INTO homebuyer(walkability, crime_rating, location, budget) VALUES (?,?,?,?)")))
          {
          ...
          if(!$stmt->execute()){
            ...
            echo "** Added " . $stmt->affected_rows . " rows to homebuyer **";
          }
          ?>

          <form action="USER_homebuyer.php">
